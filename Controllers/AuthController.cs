...
namespace Eventify.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Login([FromBody] LoginDto loginDto)
        {
            ...
            var key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(_config["Jwt:Key"])); // JWT anahtarı
            ...
            Log.Information("Kullanıcı giriş yaptı. Kullanıcı adı: {Username}, Rol: {Role}", user.Username, user.Role); // Loglama
            return Ok(new
            {
